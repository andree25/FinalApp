package com.app.finalapp.ui.groom;
...
public class GroomFragment extends Fragment implements OnMapReadyCallback {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_groom, container, false);
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        fusedLocationClient.getLastLocation().addOnSuccessListener(getActivity(), location -> {
            if (location != null) {
                ...
                searchNearbyGroomers(currentLocation);
    ...
    private void searchNearbyGroomers(LatLng location) {
        String url = "https://maps.googleapis.com/maps/api/place/nearbysearch/json?" +
                "location=" + location.latitude + "," + location.longitude +
                "&radius=100000" +
                "&type=pet_salon" +
                "&keyword=groomers|dog|pet" +
